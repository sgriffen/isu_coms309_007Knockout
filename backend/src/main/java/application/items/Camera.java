...
public class Camera extends Item {
	...
	public Camera() {
		...
		super();
		super.setEffect(20.0);
		super.setType(1);
		super.setEffectType(0);
		setCost(15);
	}
	
	public Camera(String name, String url, String desc, int cost, int owner, double range) {
		
		super(name, url, desc, cost, owner, 1, 0, 20.0);
	}
